...
def coordinates(pps, common_at = None, al_dict = None, selection = "CA"):
    ...
    The parameter selection specifies which atoms should be considered
    throughout the analysis, it should be one of the options: 'CA', for
    alpha carbons, 'CAB' for alpha and beta carbons, 'all' for all atoms, 
    'backbone' for the heavy atoms of the main chain
    """
